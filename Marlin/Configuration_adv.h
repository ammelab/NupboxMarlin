 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS    18 // (°C)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_ACCEL       200  // (mm/s^2) Lower acceleration may allow a faster feedrate.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       250       // (mA) RMS current. Multiply by 1.414 for peak current.
