...
#define STRING_CONFIG_H_AUTHOR "(Ben van, NUPBOX SKR Mini E3 V2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "NUPBOX"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 172.18
  #define DEFAULT_bedKi 33.04
  #define DEFAULT_bedKd 598.23
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 500, 15, 25 }
 ...
 */
#define Z_MIN_PROBE_PIN PC14  // PROBE PIN ON SKR
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 40.2, 1.77, -1 }
...
#define HOMING_FEEDRATE_MM_M { (30*60), (30*60), (12*60) }
